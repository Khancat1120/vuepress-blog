...
export const content = {
  ...
  ja: {
    ...
    sections: {
      ...
      experience: '研究・実務経験', awards: '受賞歴', service: '学術活動', patent: '特許', contact: '連絡先'
    },
    about: [
    ...
    experience: [
      { organization: 'Meituan（美団）', role: 'アルゴリズム研究インターン · Core Local Commerce / M17', period: '2024年9月 – 2025年1月', bullets: ['基盤LLMの事前学習に用いるWebデータのクリーニングと品質評価に従事。', 'ローカル環境への7Bモデル導入と全パラメータファインチューニングを実施。', 'Webクリーニング課題において、ファインチューニング後のモデルはGPT-4ベースラインの約96%に相当するROUGE-Lを達成。'] },
      { organization: 'Shenzhen Institute of Computing Sciences', role: '研究インターン', period: '2023年7月 – 2024年1月', bullets: ['グラフデータ管理・拡張、GNNの解釈可能性、グラフ計算、低リソース環境でのLLM適応に関する研究に従事。'] }
    ],
    awards: [
      '北京市大学生数学競技会 1等賞，2019・2020',
      '中国大学生数学競技会 1等賞，2019・2020',
      '北京郵電大学 学部生奨学金，2019–2021',
      '北京航空航天大学 計算機学院 学業奨学金，2022–2025',
