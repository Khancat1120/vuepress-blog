...
During the training process, <smalltex>W_0</smalltex> remains fixed and unchanged, while only the matrices A and B contain the trainable parameters and are subject to change.
