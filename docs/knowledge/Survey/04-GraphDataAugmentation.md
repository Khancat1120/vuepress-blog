...
By fusing in the feature space, mixed features can be obtained in the feature space <div width="50%" height="50%"><tex>h_{mixup}</tex></div>, and then map back to <div width="50%" height="50%"><tex>X_{mixup}</tex></div> in the original space.
